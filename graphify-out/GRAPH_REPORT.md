...
## Summary
- 2136 nodes · 3640 edges · 156 communities (148 shown, 8 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 98 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7891018e`
...
3. `View` - 34 edges
4. `LifeContext` - 31 edges
5. `SwiftUI` - 25 edges
6. `OneWeave — Complete Feature Catalog` - 25 edges
7. `String` - 23 edges
8. `BasicSelfThread` - 22 edges
9. `UUID` - 22 edges
10. `CareKinThread` - 21 edges

## Surprising Connections (you probably didn't know these)
- `StateMachineIndicator` --references--> `View`  [EXTRACTED]
  Sources/OneWeave/CompassView.swift → Sources/OneWeave/OneWeavePrototype.swift
...
Cohesion: 0.13
Nodes (20): persistenceFailed, EchoLifecycleState, delivered, maturing, opened, openingReady, released, sealed (+12 more)

### Community 1 - "Community 1"
Cohesion: 0.31
Nodes (6): StewardshipThread, Double, LifeContext, String, TimelineEvent, TimelineService
...
Cohesion: 0.10
Nodes (26): CognitiveLoadReading, BriefingSection, bodyThread, calendar, cognitiveLoad, echoes, eveningPrompt, greeting (+18 more)

### Community 4 - "Community 4"
Cohesion: 0.29
Nodes (10): BriefCalendarEvent, BriefEchoCountdown, BriefQuest, Comparable, UpcomingEchoSnapshot, Bool, ClosedRange, Int (+2 more)
...
Cohesion: 0.21
Nodes (13): EntityType, MemoryType, LifeEntity, LifeRelationship, RelationshipType, Bool, Data, Date (+5 more)
...
Cohesion: 0.14
Nodes (22): Calendar, Equatable, Identifiable, FamilyPod, FamilyPodDigestBuilder, FamilyPodDigestEntry, FamilyPodDigestRedactor, FamilyPodLimits (+14 more)
...
Cohesion: 0.22
Nodes (8): ExportManifest, EchoMarkdownRenderer, PortableExportBuilder, PortableExportBundle, PortableExportChecksum, encodeFailed, PortableExportPolicy, SacredEcho
...
Cohesion: 0.16
Nodes (14): CareKinThread, ThreadProtocol, TimelineEvent, Date, LifeContext, String, TimelineEvent, TimelineService (+6 more)
...
Cohesion: 0.27
Nodes (10): CommandResult, CommandKind, createQuest, logWeave, CommandPaletteView, CommandResult, PendingCommandAction, PendingCommandAction (+2 more)
...
Cohesion: 0.12
Nodes (16): Codable, AppLifecyclePhase, active, background, foreground, inactive, FamilyPodRole, quiet (+8 more)
...
Cohesion: 0.22
Nodes (8): ThreadDetailView, Color, Int, LifeContext, String, TimelineEvent, TimelineService, WeaveQuest
...
Cohesion: 0.12
Nodes (5): Foundation, LifecycleSceneBridge, MainTabView, SwiftData, SwiftUI

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (36): App, AppState, capturing, highFlow, idle, lowEnergy, reflecting, weaving (+28 more)
...
Cohesion: 0.16
Nodes (15): CompassView, GamificationHUD, StateMachineIndicator, ThreadRingView, WeaveSummaryView, QuestService, Bool, Color (+7 more)

### Community 39 - "Community 39"
Cohesion: 0.17
Nodes (13): EssenceLedgerView, StateMachineIndicator, MasteryBadge, QuestCard, RippleRow, SuggestedQuestRow, EnergyIndicator, WeaveSummaryView (+5 more)

### Community 40 - "Community 40"
Cohesion: 0.33
Nodes (4): Double, LifeGraph, ClosedRange, WeaveQuest
...
Cohesion: 0.22
Nodes (9): CaseIterable, EnergyProfile, high, low, normal, MemoryType, episodic, procedural (+1 more)
...
Cohesion: 0.10
Nodes (23): BodyThreadReading, BodyThreadSheet, BodyThreadReading, BodyThreadWeaver, HealthMetrics, LifeEntity, ImportResult, LifeGraphiOSIntegrations (+15 more)
...
Cohesion: 0.25
Nodes (8): PodVisibilityGrant, amplifier, completedQuestCount, currentHarmonyScore, currentStreak, echoCountdowns, seasonName, threadNames
...
Cohesion: 0.20
Nodes (11): CrossRippleRow, ThreadsOverviewView, BasicSelfThread, CareKinThread, Color, LifeContext, MeaningThread, StewardshipThread (+3 more)

### Community 52 - "Community 52"
Cohesion: 0.39
Nodes (6): ExportManifest, PortableImportPolicy, Bool, Date, Int, Set

### Community 53 - "Community 53"
Cohesion: 0.38
Nodes (5): CryptoKit, Darwin, AppLifecycleConstants, Security, UUID
...
Cohesion: 0.16
Nodes (14): Error, LocalizedError, PersistenceError, corruptEnvelope, CognitiveLoadPauseError, DecisionLogError, emptyOutcome, emptyReasoning (+6 more)
...
Cohesion: 0.29
Nodes (7): PortableImportError, bundleTooLarge, checksumMismatch, fullBundleRefused, invalidAttributesJSON, invalidOPML, unsupportedBundleVersion
...
Cohesion: 0.40
Nodes (4): OnboardingView, AppState, Bool, String
...
Cohesion: 0.09
Nodes (31): CognitiveLoadTrend, CognitiveLoad, CognitiveLoadComponent, activeAmplifierLoad, calendarDensity, hrvStress, openTaskCount, recentReflectionGap (+23 more)
...
Cohesion: 0.11
Nodes (24): LifeEntityDTO, LifeRelationshipDTO, AppLifecycleCoordinator, AppLifecyclePaths, LifeEntityDTO, LifeGraphEnvelope, LifeGraphPersistence, LifeRelationshipDTO (+16 more)
...
## Knowledge Gaps
- **970 isolated node(s):** `update-agent-context.sh script`, `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script` (+965 more)
...
- **Why does `Foundation` connect `Community 34` to `Community 33`, `Community 2`, `Community 3`, `Community 5`, `Community 37`, `Community 40`, `Community 9`, `Community 11`, `Community 12`, `Community 77`, `Community 13`, `Community 75`, `Community 49`, `Community 20`, `Community 53`, `Community 184`, `Community 25`, `Community 88`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `SwiftData` connect `Community 34` to `Community 32`, `Community 37`, `Community 38`, `Community 5`, `Community 136`, `Community 40`, `Community 39`, `Community 11`, `Community 75`, `Community 18`, `Community 53`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `View` connect `Community 39` to `Community 32`, `Community 34`, `Community 67`, `Community 2`, `Community 38`, `Community 136`, `Community 168`, `Community 11`, `Community 76`, `Community 45`, `Community 18`, `Community 51`, `Community 119`, `Community 23`, `Community 29`, `Community 95`?**
