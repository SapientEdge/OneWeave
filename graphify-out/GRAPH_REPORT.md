...
4. `TimelineEvent` - 19 edges
5. `SwiftUI` - 16 edges
6. `OneWeavePrototype` - 16 edges
7. `String` - 15 edges
8. `AppState` - 15 edges
9. `String` - 14 edges
...
- `applyStateTransition()` --calls--> `AppState`  [INFERRED]
  Sources/OneWeave/LifeContext.swift → Sources/OneWeave/OnboardingView.swift
- `AppState` --case_of--> `idle`  [EXTRACTED]
  Sources/OneWeave/OnboardingView.swift → Sources/OneWeave/AppStateMachine.swift
- `AppState` --case_of--> `capturing`  [EXTRACTED]
  Sources/OneWeave/OnboardingView.swift → Sources/OneWeave/AppStateMachine.swift
- `AppState` --case_of--> `weaving`  [EXTRACTED]
  Sources/OneWeave/OnboardingView.swift → Sources/OneWeave/AppStateMachine.swift
- `AppState` --case_of--> `reflecting`  [EXTRACTED]
  Sources/OneWeave/OnboardingView.swift → Sources/OneWeave/AppStateMachine.swift
...
Cohesion: 0.07
Nodes (33): EnergyProfile, CompassView, GamificationHUD, SimpleLivingLoomView, StateMachineIndicator, ThreadRingView, WeaveSummaryView, StateMachineIndicator (+25 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (21): Foundation, DataSeeder, HistoryView, ModernHistoryRow, CrossThreadInsight, InsightGenerator, MainTabView, SettingsView (+13 more)

### Community 2 - "Community 2"
Cohesion: 0.10
Nodes (32): CaseIterable, Codable, Identifiable, aggregateFromRecentEvents(), Amplifier, insightMagnifier, selfFocus, streakShield (+24 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (24): App, AppState, Equatable, capturing, highFlow, idle, lowEnergy, reflecting (+16 more)
...
Cohesion: 0.14
Nodes (13): 4 Life Threads (Protocol + Full Logic, No Stubs), Core Architecture & State (Fully Wired), Delegation e5d0e817 net (2026-06-26), Gamification & Retention Layer (002-gamification Spec MVP), Latest Gamification Progress (post-Phase 4/5 starters), Navigation & End-to-End Flows (Zero Dead Ends), OneWeave — Implemented Features & Functions (Production-Grade, Post-Gamification MVP), Parallel continuation (post-deleg_e5d0e817 + direct) (+5 more)
...
Cohesion: 0.17
Nodes (11): 1. Code & Features (Must-Have for v1), 2. UI/UX Polish (Calm Tech per White Paper), 3. Gamification & Retention (002 Spec MVP), 4. Privacy/Security (Global Best Practices + White Paper PbD), 5. Assets & Marketing, 6. Docs & SDLC, 7. Build & Submit Prep (User Side — Xcode), 8. Post-Launch / Next (+3 more)
...
Cohesion: 0.40
Nodes (4): Constitution / PbD Compliance, Files with explicit notes, OneWeave Privacy & Security Audit (Gamification Layer), Summary
...
## Knowledge Gaps
- **279 isolated node(s):** `Int`, `UUID`, `QuestStatus`, `Date`, `available` (+274 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `SwiftData` connect `Community 1` to `Community 0`, `Community 2`, `Community 16`, `Community 22`, `Community 25`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `TimelineEvent` connect `Community 2` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 12`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `SwiftUI` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 16`, `Community 22`, `Community 25`?**
