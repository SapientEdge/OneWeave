...
- **DecisionRecord** (17 connections) — `Sources/OneWeave/DecisionLog.swift`
...
- **Int** (6 connections) — `Sources/OneWeave/DecisionLog.swift`
- **.reflectionSeed()** (6 connections) — `Sources/OneWeave/DecisionLog.swift`
- **.relevantDecisions()** (6 connections) — `Sources/OneWeave/DecisionLog.swift`
- **DecisionLogStats** (6 connections) — `Sources/OneWeave/DecisionLog.swift`
- **DecisionLog** (5 connections) — `Sources/OneWeave/DecisionLog.swift`
- **.recordOutcome()** (4 connections) — `Sources/OneWeave/DecisionLog.swift`
- **.needsOutcomeReminder()** (4 connections) — `Sources/OneWeave/DecisionLog.swift`
- **.clamped()** (4 connections) — `Sources/OneWeave/DecisionLog.swift`
- **UUID** (3 connections) — `Sources/OneWeave/DecisionLog.swift`
- **Bool** (3 connections) — `Sources/OneWeave/DecisionLog.swift`
